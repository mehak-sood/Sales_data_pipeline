...
DROP TABLE IF EXISTS product_staging_table;
...
-- s3 bucket table
DROP TABLE IF EXISTS s3_bucket_info;
...
VALUES ('de-project-mehak-1', 'active', NOW(), NOW());


-- Data Mart customer
DROP TABLE IF EXISTS customers_data_mart;
...
-- sales mart table
DROP TABLE IF EXISTS sales_team_data_mart;
