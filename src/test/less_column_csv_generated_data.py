...
file_location = "/Users/mehaksood/Library/CloudStorage/GoogleDrive-mehaksood.job@gmail.com/My Drive/Project_1/generated_files/"

if not os.path.exists(file_location):
    os.makedirs(file_location)

current_str = datetime.now()
input_date_str = datetime.strftime(current_str, "%Y-%m-%d")
